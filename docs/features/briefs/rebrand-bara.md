...
- Architecture plan: add a dependency-free brand configuration for Next.js and Clerk surfaces, use neutral asset paths, remove brand-specific Convex defaults, update current docs/tests/path guidance, and add a repeatable rebrand check and runbook.
